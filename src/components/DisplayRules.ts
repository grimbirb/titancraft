  ...
  switch (info) {
    case "discord":
      ...
      str += `<div class='w-full flex justify-center'>
          <img class='block w-full md:w-1/2' src='src/assets/images/discord-rules.png' alt='Discord Server Rules'/>
        </div>`;
    ...
    case "tc":
      str = "";
      str += `<div class='w-full flex justify-center'>
          <img class='block w-full md:w-1/2' src='src/assets/images/tc-rules.png' alt='Discord Server Rules'/>
        </div>`;
    ...
    case "faq":
      str = "";
      str += `<div class='w-full flex justify-center'>
          <img class='block w-full md:w-1/2' src='src/assets/images/faq.png' alt='Discord Server Rules'/>
        </div>`;
      str += `<div class='px-3 md:px-30 flex flex-col gap-4'>`;
      faq.forEach((rule) => {
        rule.header
